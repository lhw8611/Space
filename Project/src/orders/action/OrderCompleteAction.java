...
public class OrderCompleteAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		MemberBean membean = (MemberBean)session.getAttribute("membean");
		ProductBean probean = (ProductBean)session.getAttribute("probean");
		...
		qtybean = ordercompletesvc.productqty(probean.getPro_code());
