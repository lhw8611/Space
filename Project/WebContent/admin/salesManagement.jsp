					...
					function cl() {
						if (typeof window["Highcharts"] !== "undefined") {
							...
							var options = {
								...
								"isStock" : true,
								"data" : {
									"csv" : "\"DateTime\";\"sales\"\n\"2019-01-10\";<%=map.get(1)%>\n\"2019-02-02\";<%=map.get(2)%>\n\"2019-03-03\";<%=map.get(3)%>\n\"2019-04-10\";<%=map.get(4)%>\n\"2019-05-10\";<%=map.get(5)%>\n\"2019-06-10\";<%=map.get(6)%>\n\"2019-07-10\";<%=map.get(7)%>\n\"2019-08-10\";<%=map.get(8)%>\n\"2019-09-10\";<%=map.get(9)%>\n\"2019-10-10\";<%=map.get(10)%>\n\"2019-11-10\";<%=map.get(11)%>\n\"2019-12-10\";<%=map.get(12)%>",
