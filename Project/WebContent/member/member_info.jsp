		...
		<table border=1>
			...
			<tr>
				<td colspan="2"><input type="text" name="mem_zip" id="mem_zip"
					placeholder="우편번호" size="7" value="<%=member.getMem_zip() %>"> <input type="button"
			...
			<tr>
				<td colspan="2"><input type="text" name="mem_add2" id="mem_add2"
			...
			<tr>
				...
				<td><input type="tel" name="tel" id="tel" value="<%=member.getMem_tel() %>"/></td>
			</tr>
			<tr>
			<tr>
